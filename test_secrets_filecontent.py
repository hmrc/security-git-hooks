...
def test_aws_secret_key__does_not_match_with_equals_sign_separator__TO_REVIEW():
    aws_secret_key = "aws_secret_access_key=H5xnFhnR3H/o6nrcfoMLR9VfOlfOY17pa/+PchnA"
    assert secrets_filecontent.detect_secret_in_line(aws_secret_key) is None
...
def test_cert_1_RSA_pub_key_does_not_match():
    ...
    assert secrets_filecontent.detect_secret_in_line(cert_1) is None
...
def test_application_secret_doesnt_match_as_words_in_string():
    ...
    assert secrets_filecontent.detect_secret_in_line(application_secret) is None
...
def test_play_crypto_secret_doesnt_match_when_encrypted_with_colon_separator():
    ...
    assert secrets_filecontent.detect_secret_in_line(play_crypto_secret) is None
...
def test_cookie_deviceId_secret_doesnt_match_when_encrypted_with_colon_separator():
    ...
    assert secrets_filecontent.detect_secret_in_line(cookie_deviceId_secret) is None
...
def test_sso_encryption_key_doesnt_match_when_encrypted_with_colon_separator():
    ...
    assert secrets_filecontent.detect_secret_in_line(sso_encryption_key) is None
