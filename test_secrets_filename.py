...
def test_rsa_extension_match():
    filename = "fake_rsa"
    assert secrets_filename.detect_match_against_filename(filename) == "rsa"
...
def test_dsa_extension_match():
    filename = "fake_dsa"
    assert secrets_filename.detect_match_against_filename(filename) == "dsa"
...
def test_ed25519_extension_match():
    ...
    assert secrets_filename.detect_match_against_filename(filename) == "ed25519"
...
def test_ecdsa_extension_match():
    filename = "fake_ecdsa"
    assert secrets_filename.detect_match_against_filename(filename) == "ecdsa"
...
def test_bash_config_bashrc_match():
    filename = ".bashrc"
    assert secrets_filename.detect_match_against_filename(filename) == "bash/zsh rc file"
...
def test_bash_config_bash_profile_match():
    ...
    assert secrets_filename.detect_match_against_filename(filename) == "bash/zsh profile"
...
def test_bash_config_bash_aliases_match():
    ...
    assert secrets_filename.detect_match_against_filename(filename) == "bash/zsh aliases file"
...
def test_credential_extension_match():
    filename = ".credential"
    assert secrets_filename.detect_match_against_filename(filename) == "credential(s) file"
...
def test_github_enterprise_extension_match():
    ...
    assert secrets_filename.detect_match_against_filename(filename) == "Github Enterprise file"
...
def test_apple_keychain_extension_match():
    filename = ".keychain"
    assert secrets_filename.detect_match_against_filename(filename) == "Apple Keychain file"
...
def test_keystore_match___TO_REVIEW():
    filename = "keystore"
    assert secrets_filename.detect_match_against_filename(filename) == "Keystore/Keyring file"
